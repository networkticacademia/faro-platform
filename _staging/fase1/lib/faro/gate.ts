 ...
 * misma filosofía que TarjetaConvergencia ("bajo demanda, no automático").
 *
 * Este bloque implementa SOLO C0. C1/C2 quedan definidos en el tipo pero
 * sin activar (bloqueado_forzado: false) hasta validar C0 con el proyecto
 * piña real — ver FARO_fase1_gate_checkpoints_preguntas.md, sección 7.
 */
