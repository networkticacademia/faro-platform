 ...
 *
 * IMPORTANTE: esto NO es un chat abierto (eso es el ítem #12 de la
 * auditoría, fuera de alcance). Es una única llamada, con contexto
 * mínimo pero real del proyecto (nodo origen + campo + lo ya confirmado
 * en RUTA), que responde una pregunta puntual y termina.
 *
 * IMPORTANTE PARA ANTIGRAVITY: verificar la firma real de
 * llamarOrquestador() — se asume aquí (prompt: string) => Promise<string>,
 * ajustar si el contrato real difiere.
 */
