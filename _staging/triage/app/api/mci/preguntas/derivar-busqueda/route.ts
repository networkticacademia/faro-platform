...
/**
 * "No sé dónde conseguirla" — genera orientación + los dos prompts
 * estandarizados (buscar / traer resultado en formato usable), tal como
 * ya existe en RSL y en Contexto. La pregunta queda 'diferida', no
 * bloquea si no es P1, y el formulador vuelve a ella cuando tenga el
 * dato (cae al flujo normal de /responder).
 */
