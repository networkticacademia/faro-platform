  ...
  if (camino === "no_entiendo") {
    return (
      <div className="space-y-2">
        {cargando && <p className="text-xs text-gray-500">Consultando explicación con contexto...</p>}
        {explicacion && (
          <div className="whitespace-pre-wrap rounded-lg border bg-white p-3 text-xs sm:text-sm text-gray-700 shadow-sm">
            {explicacion}
          </div>
        )}
